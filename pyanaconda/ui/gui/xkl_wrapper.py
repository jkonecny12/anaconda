...
from pyanaconda.ui.gui.gk_keyboard_manager import GkKeyboardManager
...
class XklWrapper(object):
    ...
    def __init__(self):
        self._keyboard_manager = GkKeyboardManager()
    ...
    def compositor_selected_layout_changed(self):
        ...
        return self._keyboard_manager.compositor_selected_layout_changed

    @property
    def compositor_layouts_changed(self):
        """Signal emitted when available layouts change."""
        return self._keyboard_manager.compositor_layouts_changed
    ...
    def get_current_layout(self):
        ...
        return self._keyboard_manager.get_compositor_selected_layout()
    ...
    def activate_default_layout(self):
        ...
        layouts = self._keyboard_manager.get_compositor_layouts()
        self._keyboard_manager.set_compositor_selected_layout(layouts[0])
    ...
    def activate_layout(self, layout):
        ...
        :param layout: layout defined as either 'layout' or 'layout (variant)'
        :type layout: str

        :raise KeyboardConfigError: if layouts with invalid backend type is found
        """

        self._keyboard_manager.set_compositor_selected_layout(layout)
    ...
    def replace_layouts(self, layouts_list):
        ...
        self._keyboard_manager.set_compositor_layouts(layouts_list, self._switching_options)
    ...
    def set_switching_options(self, options):
        ...
        layouts = self._keyboard_manager.get_compositor_layouts()
        self._keyboard_manager.set_compositor_layouts(layouts, self._switching_options)
